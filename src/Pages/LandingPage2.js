import {Button, Col, Container, Figure, Form, Image, Row} from "react-bootstrap";
...
export default function LandingPage2(props) {
    ...
    const features = [
        { img: feature1Rebanho, title: "Rebanho", description: "Tenha uma visão abrangente e detalhada do seu rebanho" },
        { img: feature3NewAnimal, title: "Seu gado", description: "Cadastre e edite as informações de cada animal" },
        { img: feature4Relatorios, title: "Relatórios", description: "Visualize relatórios sobre o seu rebanho" },
        { img: feature5Monitoramento, title: "Monitoramentos", description: "Monitore as últimas atualizações do seu rebanho" },
    ]
    ...
    return (
        <>
                    ...
                    <Row className="justify-content-center">
                        <Col md={7} className="align-self-center">
                            <Card className="bg-transparent border-0 text-white">
                                <Card.Body>
                                    <Card.Title>
                                        <h1 className="fw-bold display-4">O seu rebanho na palma da mão</h1>
                                    </Card.Title>
                                    <Card.Text>
                                        <span style={{ textAlign: 'justify' }}>
                                            Aplicativo desenvolvido para auxiliar pequenos pecuaristas do Brasil a ter um melhor controle do rebanho
                                        </span>
                                    </Card.Text>
                                    <Button variant="success" className="me-3" 
                                            onClick={handleShowLogin}>Entrar</Button>
                                    <Button variant="outline-success" className="btn-criar-conta" 
                                            onClick={handleShowSignUp}>Criar conta</Button>
                                </Card.Body>
                            </Card>
                        </Col>
                        <Col sm={2} md={5} lg={4} className="d-none d-md-block">
                            <Image src={cow} style={{ maxWidth: 336, width: '100%' }} />
                        </Col>
                    </Row>
                </Container> 
            </section>
            <section className="features-section py-5">
                <Container>
                    <h2 className="display-6 text-center text-white fw-bold my-3">Principais recursos</h2>
                    <hr/>
                </Container>
                <Container>
                    <Row className="justify-content-center gx-3">
                        {
                            features.map((feature, index) => 
                                <Col xs={12} md={6} lg={4} key={index} style={{ color: 'white' }}>
