        ...
        <Container>
            <Card>
                <Card.Header className="">
                    {oneAnimal.nome} <span className="font-monospace text-muted float-sm-end">#{oneAnimal._id}</span>
                </Card.Header>
                <Card.Body>
                    ...
                    <Form>
                        <Row className="py-3">
                            <Col xs="4">
                                <Container className="cow-details-img-container mx-3">
                                    <img src={oneAnimal.imagem_url || imgPlaceholder} alt="cow-image" className="w-75"/>
                                </Container>
                            </Col>
                                    ...
                                    <Row>
                                        <Col>
                                            <Form.Check
                                                ...
                                                onChange={_ => setOneAnimal(prevState =>
                                                    ({...prevState, noCurral: !prevState.noCurral})
                                                )}
                                            />
                                        </Col>
                                        <Col>
                                            <Form.Check
                                                ...
                                                className="text-nowrap"
                                                onChange={_ => setOneAnimal(prevState =>
                                                    ({...prevState, morreu: !prevState.morreu})
                                                )}
                                            />
                                        </Col>
                                        <Col>
                                            <Form.Check
                                                ...
                                                className="text-nowrap"
                                                onChange={_ => setOneAnimal(prevState =>
                                                    ({...prevState, vendida: !prevState.vendida})
                                                )}
                                            />
                                        </Col>
                                    </Row>
                        ...
                        <Row className="g-2">
                            <Col xs={12}>
                                <Card.Subtitle className="mb-3">Outras informações</Card.Subtitle>
                            </Col>
                            ...
                            <Col md={6}>
                                <Form.Group as={Row}>
                                    <Form.Label column xs={3} className="text-nowrap"
                                                htmlFor="brinco">Brinco:</Form.Label>
                                    <Col xs={9}>
                                        <Form.Control
                                            type="number"
                                            id="brinco"
                            ...
                            <Col xs={9}>
                                <Form.Control 
                                    ...
                                    onChange={e => setOneAnimal(prevState => 
                                        ({ ...prevState, dtNascimento: e.target.value  }))}
                                />
                            </Col>
                        </Row>
                    </Form>
